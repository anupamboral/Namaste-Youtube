    ...
    <div className="Head  p-2 shadow-lg grid grid-flow-col bg-black ">
      <div className=" flex grid-cols-1">
        <svg
          ...
          focusable="false"
          aria-hidden="true"
          className="h-9  w-8 mt-3 mr-1 bg-white hover:shadow-white hover:shadow-lg cursor-pointer rounded-3xl "
        >
          <path d="M21 6H3V5h18v1zm0 5H3v1h18v-1zm0 6H3v1h18v-1z"></path>
        </svg>
        <img
          className="h-16 w-40 cursor-pointer hover:shadow-white hover:shadow-sm rounded-3xl transition-all "
          alt="logo"
